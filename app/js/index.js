...
let minLong;
let maxRadius;
const client_id = "WYEFOAHKJ1IJXRM1JARRHRA1VMCTIU5L4OCN3QWGCJTXOHJH"; 
const client_secret = "TLGXT0E0CN31D5QSLIHLPVNMUZBUG4Q2ZKT5JOD3HFIFUWHA"; 
...
function instable(event){
  if(event.keyCode == 13){
      const FourSquareAPI = api_url + '?client_id=' + client_id + '&client_secret=' + client_secret + '&v=' + version + '&ll=' + tokyo.lat + ',' + tokyo.lng + '&query=' + event.target.value + '&limit=' + limit;
